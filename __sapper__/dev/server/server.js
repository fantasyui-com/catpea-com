...
const Tail = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
...
<footer class="${"container-fluid"}">
	...
	<div class="${"bg-secondary shadow border-primary border-bottom rounded-lg my-3 p-3 text-center"}">
...
${validate_component(Tail, "Tail").$$render($$result, {}, {}, {})}`;
});
