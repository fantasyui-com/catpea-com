...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "card-header align-middle");
			...
			add_location(p, file$1, 68, 4, 1727);
