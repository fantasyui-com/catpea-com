...
function create_if_block_1(ctx) {
	...
	let div0;
	let t0;
	let t1_value = octicons.alert.svg + "";
	let t1;
	let t2;
	let div3;
	let p;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$1, 65, 4, 1423);
