...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t5 = claim_text(div3_nodes, /*progress*/ ctx[2]);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*progress*/ 4) set_data_dev(t5, /*progress*/ ctx[2]);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "btn btn-text btn-sm border border-secondary float-right");
			add_location(button, file$1, 61, 6, 1080);
			attr_dev(div0, "class", "card-header lead");
			add_location(div0, file$1, 59, 4, 998);
			attr_dev(label, "class", "small");
			attr_dev(label, "for", "originalBeat");
			add_location(label, file$1, 66, 6, 1302);
...
*/
	...
	setInterval(
		function () {
			if (elapsed >= preferences.duration) {
				next();
			}

			elapsed++; // each second elapsed is incremented
			$$invalidate(2, progress = calculatePercent(elapsed, preferences.duration) * 100);
		},
		1000
	);
