...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button1, file, 45, 6, 957);
			attr_dev(small, "class", "text-info");
			add_location(small, file, 46, 32, 1055);
			attr_dev(p, "class", "card-text py-3");
			add_location(p, file, 46, 6, 1029);
