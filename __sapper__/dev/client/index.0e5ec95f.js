...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$1, 64, 6, 1530);
			attr_dev(div0, "class", "card-header py-1");
			...
			add_location(p, file$1, 68, 4, 1719);
