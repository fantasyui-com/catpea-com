...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "btn btn-text btn-sm border border-secondary float-right");
			add_location(button, file$1, 42, 6, 781);
			attr_dev(div0, "class", "card-header lead");
			add_location(div0, file$1, 40, 4, 699);
			attr_dev(label, "class", "small");
			attr_dev(label, "for", "originalBeat");
			add_location(label, file$1, 47, 6, 1003);
...
function instance($$self, $$props, $$invalidate) {
	...
	let view = 1; /* 0 is preferences, 1 is application, add as many as needed */
