...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t8 = space();
			p1 = element("p");
			t9 = text("Start hitting the beat button to measure BPM.");
			this.h();
		},
		l: function claim(nodes) {
			...
			t9 = claim_text(p1_nodes, "Start hitting the beat button to measure BPM.");
		...
		h: function hydrate() {
			...
			add_location(button0, file, 40, 6, 797);
			attr_dev(button1, "class", "btn btn-secondary");
			add_location(button1, file, 41, 6, 865);
			attr_dev(p1, "class", "card-text small text-muted");
			add_location(p1, file, 42, 6, 937);
