...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h3, "class", "card-title text-white text-center p-5");
			add_location(h3, file, 41, 2, 751);
			attr_dev(button0, "class", "btn btn-primary");
			add_location(button0, file, 42, 6, 827);
			attr_dev(button1, "class", "btn btn-secondary");
			add_location(button1, file, 43, 6, 895);
			attr_dev(small, "class", "text-muted");
			add_location(small, file, 44, 32, 993);
			attr_dev(p, "class", "card-text py-3");
			add_location(p, file, 44, 6, 967);
