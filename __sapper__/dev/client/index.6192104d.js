...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "btn btn-text border border-secondary float-right");
			add_location(button, file$1, 61, 26, 1483);
			attr_dev(div0, "class", "card-header");
			add_location(div0, file$1, 60, 4, 1404);
			attr_dev(p, "class", "card-text pb-4 text-warning lead text-center pt-4");
			set_style(p, "cursor", "pointer");
			add_location(p, file$1, 65, 4, 1665);
