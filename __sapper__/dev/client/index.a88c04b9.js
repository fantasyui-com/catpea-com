...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h5, file, 43, 1, 690);
			attr_dev(p0, "class", "card-text lead");
			add_location(p0, file, 44, 3, 742);
			attr_dev(p1, "class", "card-text small");
			add_location(p1, file, 45, 3, 790);
			attr_dev(button0, "class", "btn btn-primary");
			add_location(button0, file, 46, 6, 874);
			attr_dev(button1, "class", "btn btn-secondary");
			add_location(button1, file, 47, 6, 942);
			attr_dev(div0, "class", "card-body");
			add_location(div0, file, 42, 1, 665);
