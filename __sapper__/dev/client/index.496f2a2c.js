...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h5, file, 35, 1, 713);
			attr_dev(p0, "class", "card-text lead");
			add_location(p0, file, 36, 3, 765);
			attr_dev(p1, "class", "card-text small");
			add_location(p1, file, 37, 3, 813);
			attr_dev(button0, "class", "btn btn-primary");
			add_location(button0, file, 38, 6, 897);
			attr_dev(button1, "class", "btn btn-secondary");
			add_location(button1, file, 39, 6, 965);
			attr_dev(div0, "class", "card-body");
			add_location(div0, file, 34, 1, 688);
			attr_dev(div1, "class", "card text-white bg-dark shadow");
			add_location(div1, file, 33, 0, 642);
