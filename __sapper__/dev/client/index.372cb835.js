...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 60, 4, 1335);
			...
			add_location(div4, file$1, 59, 2, 1258);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$1, 44, 6, 813);
