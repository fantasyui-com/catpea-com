...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 45, 33, 892);
			attr_dev(a0, "href", a0_href_value = /*videos*/ ctx[0].url);
			add_location(a0, file$2, 45, 10, 869);
			attr_dev(h5, "class", "card-text");
			add_location(h5, file$2, 47, 12, 1012);
			attr_dev(p0, "class", "card-text");
			add_location(p0, file$2, 48, 12, 1065);
			attr_dev(a1, "href", a1_href_value = /*videos*/ ctx[0].url);
			attr_dev(a1, "class", "btn btn-primary");
			add_location(a1, file$2, 49, 12, 1116);
			attr_dev(small, "class", "text-muted");
			add_location(small, file$2, 50, 33, 1222);
			attr_dev(p1, "class", "card-text");
			add_location(p1, file$2, 50, 12, 1201);
			attr_dev(div0, "class", "card-body p-3");
			add_location(div0, file$2, 46, 10, 972);
			attr_dev(div1, "class", "card text-white bg-dark shadow");
			add_location(div1, file$2, 44, 8, 814);
			attr_dev(div2, "class", "col");
			add_location(div2, file$2, 43, 4, 788);
			attr_dev(div3, "class", "col");
			add_location(div3, file$2, 55, 4, 1333);
			attr_dev(div4, "class", "col");
			add_location(div4, file$2, 56, 4, 1367);
