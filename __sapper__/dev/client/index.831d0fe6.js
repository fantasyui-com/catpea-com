...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file$1, 48, 6, 1041);
			attr_dev(span, "class", "input-group-text");
			attr_dev(span, "id", "basic-addon2");
			add_location(span, file$1, 50, 8, 1226);
			attr_dev(div1, "class", "input-group-append");
			add_location(div1, file$1, 49, 8, 1185);
			attr_dev(div2, "class", "input-group mb-3");
			add_location(div2, file$1, 47, 6, 1004);
			attr_dev(div3, "class", "card-text");
			add_location(div3, file$1, 44, 6, 902);
			attr_dev(div4, "class", "card-body py-3");
			add_location(div4, file$1, 43, 4, 867);
