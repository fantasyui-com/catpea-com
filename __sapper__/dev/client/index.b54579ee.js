...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h6, "class", "card-text pb-4 text-muted");
			add_location(h6, file$2, 76, 6, 2630);
		},
		m: function mount(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h6, "class", "card-text pb-4 text-info");
			add_location(h6, file$2, 74, 6, 2555);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h6, anchor);
			append_dev(h6, t);
