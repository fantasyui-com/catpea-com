	...
	const block = {
		...
		m: function mount(target, anchor) {
			...
			dispose = [
				...
				listen_dev(p, "click", /*next*/ ctx[5], false, false, false)
			];
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "btn btn-text btn-sm border border-secondary float-right");
			add_location(button, file$1, 70, 6, 1175);
			attr_dev(div0, "class", "card-header lead");
			add_location(div0, file$1, 68, 4, 1093);
			attr_dev(label, "class", "small");
			attr_dev(label, "for", "originalBeat");
			add_location(label, file$1, 75, 6, 1397);
...
*/
	...
	function next() {
		...
		// Set Advice
		$$invalidate(3, advice = list[index]);
	}
