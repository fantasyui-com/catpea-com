...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$1, 64, 6, 1538);
			attr_dev(div0, "class", "card-header lead");
			add_location(div0, file$1, 62, 4, 1460);
			...
			add_location(div4, file$1, 61, 2, 1383);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$1, 46, 6, 938);
			...
			add_location(input, file$1, 48, 6, 1046);
			attr_dev(span, "class", "input-group-text");
			attr_dev(span, "id", "basic-addon2");
			add_location(span, file$1, 50, 8, 1231);
			attr_dev(div1, "class", "input-group-append");
			add_location(div1, file$1, 49, 8, 1190);
			attr_dev(div2, "class", "input-group mb-3");
			add_location(div2, file$1, 47, 6, 1009);
			attr_dev(div3, "class", "card-text");
			add_location(div3, file$1, 44, 6, 907);
			attr_dev(div4, "class", "card-body py-3");
			add_location(div4, file$1, 43, 4, 872);
