...
function create_if_block_1(ctx) {
	...
	let t0;
	let html_tag;
	let raw_value = octicons.alert.toSVG({ "class": "text-white" }) + "";
	let t1;
	let div3;
	let p;
	let t2;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$1, 65, 4, 1458);
