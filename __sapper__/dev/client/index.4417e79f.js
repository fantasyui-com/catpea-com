...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t9 = claim_text(div2_nodes, /*beatCounter*/ ctx[0]);
			t10 = claim_space(div2_nodes);
			div1 = claim_element(div2_nodes, "DIV", { class: true });
			var div1_nodes = children(div1);
			button1 = claim_element(div1_nodes, "BUTTON", { class: true });
			var button1_nodes = children(button1);
			t11 = claim_text(button1_nodes, "Reset");
		...
		h: function hydrate() {
			...
			add_location(button1, file, 53, 6, 1168);
			attr_dev(div1, "class", "text-right");
			add_location(div1, file, 52, 4, 1137);
			attr_dev(div2, "class", "card-body");
			add_location(div2, file, 46, 1, 790);
			attr_dev(div3, "class", "card text-white bg-dark shadow");
			add_location(div3, file, 42, 0, 688);
		},
