...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			p1 = element("p");
			small = element("small");
			t11 = text("Start hitting the beat button.");
			this.h();
		},
		l: function claim(nodes) {
			...
			t11 = claim_text(small_nodes, "Start hitting the beat button.");
