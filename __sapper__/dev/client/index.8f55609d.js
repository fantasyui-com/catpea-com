...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h5, file, 42, 1, 706);
			attr_dev(p0, "class", "card-text lead");
			add_location(p0, file, 43, 3, 758);
			attr_dev(p1, "class", "card-text small");
			add_location(p1, file, 44, 3, 806);
			attr_dev(button0, "class", "btn btn-primary");
			add_location(button0, file, 45, 6, 890);
			attr_dev(button1, "class", "btn btn-secondary");
			add_location(button1, file, 46, 6, 958);
			attr_dev(div0, "class", "card-body");
			add_location(div0, file, 41, 1, 681);
			attr_dev(div1, "class", "card text-white bg-dark shadow");
			add_location(div1, file, 40, 0, 635);
