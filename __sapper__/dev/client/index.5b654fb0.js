...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "card-text pb-3");
			add_location(h4, file$2, 71, 6, 2293);
		},
		m: function mount(target, anchor) {
