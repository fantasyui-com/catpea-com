...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$1, 64, 6, 1525);
			attr_dev(div0, "class", "card-header");
			add_location(div0, file$1, 62, 4, 1452);
			attr_dev(p, "class", "card-text pb-4 text-warning lead text-center pt-4");
			set_style(p, "cursor", "pointer");
			add_location(p, file$1, 68, 4, 1714);
...
function create_if_block(ctx) {
	...
	function input_input_handler() {
		input_updating = true;
		/*input_input_handler*/ ctx[7].call(input);
	}
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "btn btn-text btn-sm border border-secondary float-right");
			add_location(button, file$1, 41, 6, 713);
			attr_dev(div0, "class", "card-header");
			add_location(div0, file$1, 39, 4, 634);
			attr_dev(label, "class", "small");
			attr_dev(label, "for", "originalBeat");
			add_location(label, file$1, 46, 6, 930);
