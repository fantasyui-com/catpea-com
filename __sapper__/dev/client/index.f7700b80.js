...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h3, "class", "card-text pb-4");
			add_location(h3, file$2, 71, 6, 2293);
		},
		m: function mount(target, anchor) {
