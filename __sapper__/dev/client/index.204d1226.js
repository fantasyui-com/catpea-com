...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "btn btn-text border border-dark");
			add_location(button, file$1, 61, 26, 1466);
			attr_dev(div0, "class", "card-header");
			add_location(div0, file$1, 60, 4, 1387);
			attr_dev(p, "class", "card-text pb-4 text-warning lead text-center pt-4");
			set_style(p, "cursor", "pointer");
			add_location(p, file$1, 65, 4, 1631);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$1, 44, 6, 865);
